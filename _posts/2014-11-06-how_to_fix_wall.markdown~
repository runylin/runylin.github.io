...
首先要感谢_班里老板_的折腾和[这个帖子](http://www.miui.com/thread-1843323-1-1.html),很快就用他的帐号就能全局翻过去了.

###升级小米路由用shadowsock翻墙修复
#####step1: 修改帐号密码端口 shadowsocks.json ,运行
...
iptables -t nat -A SHADOWSOCKS -d 116.251.217.93 -j RETURN
...
##### step3:/etc/init.d/firewall restart
